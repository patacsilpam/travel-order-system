<!-- Modal -->
<div class="modal fade" id="addDivision" tabindex="-1" role="dialog" aria-labelledby="addDivision" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addPosition">Add Division</h5>
